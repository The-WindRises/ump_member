package it.swiftelink.com.vcs_member.weight.largeImage.images;

import android.graphics.RectF;
import android.widget.ImageView;

import it.swiftelink.com.vcs_member.weight.largeImage.PinchImageView;
...
public class MyImageSource implements ImageSource {
    ...
    public MyImageSource(String originUrl, int originWidth, int originHeight) {
