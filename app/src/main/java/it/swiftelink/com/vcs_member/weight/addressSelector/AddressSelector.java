...
public class AddressSelector extends LinearLayout implements View.OnClickListener{
    ...
    private void init(Context context){
        ...
        addView(tabs_layout);
        tabs = new ArrayList<>();
        Tab tab = newTab(getContext().getString(R.string.label_to_select),true);
        ...
        grayLine.setBackgroundColor(mContext.getResources().getColor(R.color.lineColor2));
        addView(grayLine);
                ...
                public void onClick(View v) {
                    if(onItemClickListener != null){
                        ...
                        if(tabIndex+1 < tabs.size()){
                            ...
                            resetAllTabs(tabIndex);
                            line.setIndex(tabIndex);
                            tabs.get(tabIndex).setText(getContext().getString(R.string.please_select));
