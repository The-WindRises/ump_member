...
public class PayPsdInputView extends EditText {
     ...
     * 底部线的颜色   默认GRAY
     */
    private int bottomLineColor = Color.WHITE;
    /**
     * 分割线的颜色
     */
     ...
     * @param canvas
     */
    private void drawWeBorder(Canvas canvas) {
...
//        canvas.drawRoundRect(focusedRecF, rectAngle, rectAngle, getPaint(3, Paint.Style.STROKE, focusedColor));
     ...
     * @param listener
     */
    public void setCompareFinish(onPasswordListener listener) {
        mListener = listener;
    }
