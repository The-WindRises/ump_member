...
public class KeyboardUtil {
    ...
    public  static final float KEYBOARY_H = 0.34f;
    ...
    public void initLayoutHeight(LinearLayout layoutView) {
        ...
        if (keyboard_layoutlLayoutParams == null) {
            int height = (int) (mActivity.getResources().getDisplayMetrics().heightPixels * KEYBOARY_H);
            layoutView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, height));
        } else {
            keyboard_layoutlLayoutParams.height = (int) (mActivity.getResources().getDisplayMetrics().heightPixels * KEYBOARY_H);
        }
    }
...
//				return;
    ...
    public void showKeyBoardLayout(int keyBoardType, int scrollTo) {
        showKeyBoardLayout(ed, keyBoardType, scrollTo);
    }
